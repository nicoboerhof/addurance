    ...
    (function () {
      ...
      function resize() {
        ...
        const ch = (vv ? vv.height - navOffset : null) || container.clientHeight || window.innerHeight - navOffset;
    ...
    function goToStart() {
      if (raf) { cancelAnimationFrame(raf); raf = null; }
        ...
        document.documentElement.style.overflow = 'auto'; // desktop fix
      ...
      function startGame() {
        ...
        if (gameState === 'playing') document.body.style.overflow = 'hidden';
